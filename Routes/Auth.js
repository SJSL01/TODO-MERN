...
router.post("/signup",
    ...
    body("username").isAlphanumeric().withMessage("No special characters allowed in username").isLength({ min: 4, max: 10 }).withMessage("Username must be between 4 to 10 characters."),
